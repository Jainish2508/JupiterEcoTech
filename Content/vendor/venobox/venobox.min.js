			...
			return ee.cb_init(L), this.each(function () {
				...
				function K() {
					_ = D.data("gall"), f = D.data("numeratio"), h = D.data("gallItems"), k = D.data("infinigall"), H = D.data("share"), o.html(""), "iframe" !== D.data("vbtype") && "inline" !== D.data("vbtype") && "ajax" !== D.data("vbtype") && (Q = {
						...
						o.append(Q[s])
					})), (p = h || e('.vbox-item[data-gall="' + _ + '"]')).length < 2 && (k = !1, f = !1), C = p.eq(p.index(D) + 1), z = p.eq(p.index(D) - 1), C.length || !0 !== k || (C = p.eq(0)), p.length >= 1 ? (N = p.index(D) + 1, t.html(N + " / " + p.length)) : N = 1, !0 === f ? t.show() : t.hide(), "" !== y ? c.show() : c.hide(), C.length || !0 === k ? (e(".vbox-next").css("display", "block"), B = !0) : (e(".vbox-next").css("display", "none"), B = !1), p.index(D) > 0 || !0 === k ? (e(".vbox-prev").css("display", "block"), P = !0) : (e(".vbox-prev").css("display", "none"), P = !1), !0 !== P && !0 !== B || (d.on(le.DOWN, oe), d.on(le.MOVE, ce), d.on(le.UP, re))
				}

				function se(e) {
					return !(e.length < 1) && (!g && (g = !0, x = e.data("overlay") || e.data("overlaycolor"), u = e.data("framewidth"), b = e.data("frameheight"), r = e.data("border"), i = e.data("bgcolor"), n = e.data("href") || e.attr("href"), s = e.data("autoplay"), y = e.data("titleattr") && e.attr(e.data("titleattr")) || "", e === z && d.addClass("vbox-animated").addClass("swipe-right"), e === C && d.addClass("vbox-animated").addClass("swipe-left"), E.show(), void d.animate({
						opacity: 0
					}, 500, function () {
						w.css("background", x), d.removeClass("vbox-animated").removeClass("swipe-left").removeClass("swipe-right").css({
							"margin-left": 0,
							"margin-right": 0
				...
				function ae() {
					...
					e("body").off("keydown", ie).removeClass("vbox-open"), D.focus(), w.animate({
						opacity: 0
					}, 500, function () {
				...
				ee.overlayClose || (te = ".vbox-close"), e("body").on("click touchstart", te, function (s) {
				...
				function pe() {
					(I = d.find("img")).length ? I.each(function () {
				...
				function ge() {
					c.html(y), d.find(">:first-child").addClass("vbox-figlio").css({
						width: u,
						height: b,
						padding: r,
						background: i
				...
				"ontouchstart" in window ? (e(document).on("touchstart", ne), e(document).on("touchmove", ne), e(document).on("touchend", ne)) : (e(document).on("mousedown", de), e(document).on("mouseup", de), e(document).on("mouseout", de), e(document).on("mousemove", de)), e(window).resize(function () {
